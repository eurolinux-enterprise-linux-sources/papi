/*
* File:    perfmon-ia64.c
* CVS:     $Id: perfmon-ia64.c,v 1.1 2011/04/14 21:50:39 vweaver1 Exp $
* Author:  Philip Mucci
*          mucci@cs.utk.edu
* Mods:	   Kevin London
*	   london@cs.utk.edu
...
_ia64_init_substrate( int cidx )
{
	...
	strcpy( MY_VECTOR.cmp_info.name,
			"$Id: perfmon-ia64.c,v 1.1 2011/04/14 21:50:39 vweaver1 Exp $" );
	strcpy( MY_VECTOR.cmp_info.version, "$Revision: 1.1 $" );
