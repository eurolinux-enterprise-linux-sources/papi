/*
* File:    linux-ia64.c
* CVS:     $Id: linux-ia64.c,v 1.183 2010/05/19 18:00:57 bsheely Exp $
* Author:  Philip Mucci
*          mucci@cs.utk.edu
* Mods:	   Kevin London
*	   london@cs.utk.edu
...
_ia64_get_system_info( void )
{
	...
	strcpy( MY_VECTOR.cmp_info.name,
			"$Id: linux-ia64.c,v 1.183 2010/05/19 18:00:57 bsheely Exp $" );
	strcpy( MY_VECTOR.cmp_info.version, "$Revision: 1.183 $" );
